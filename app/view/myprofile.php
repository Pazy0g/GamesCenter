            ...
            <div class="col-md-9 order-md-1">
                ...
                <div class="row pb-4">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text"><strong>Pseudo:</strong> Nom d'utilisateur</p>
                                <p class="card-text"><strong>Email:</strong> utilisateur@mail.com</p>
                                ...
                                <div class="container pt-4">
                                    <h3 class="text-center">Mes jeux préférés</h1>
