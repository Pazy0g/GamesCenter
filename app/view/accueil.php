                        ...
                        <div class="card">
                            <a href="/">
                                ...
                                <div class="card_content">
                                    <h2 class="card_title">Titre jeu 1</h2>
                                    <div class="card_text">
                                        <p>TOP 1<br>
                                            Note moyenne :
                                        </p>
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <a href="/">
                                ...
                                <div class="card_content">
                                    <h2 class="card_title">Titre jeu 2</h2>
                                    <div class="card_text">
                                        <p>
                                            TOP 2 <br>
                                            Note moyenne :
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <a href="/">
                                ...
                                <div class="card_content">
                                    <h2 class="card_title">Titre jeu 3</h2>
                                    <div class="card_text">
                                        <p>
                                            TOP 3 <br>
                                            Note moyenne :
                                        ...
                                        <p>
                                            DESCRIPTION
                                            ddqsdqsdsqdsqdqs
                                            dqsdqsdqsdsqdsqdsqdsq
                                            sqdqsdsqdsqdsqdqsdqsdsqdqsdsqdqsdqsd
                                            sdqsdqsdqsdsqfgfdgfdgffgdfgdfgdfg
                                            fdgfdgdfgdfgfdgdfgdfgdfg
                                        </p>
                                    </div>
                                </div>
                            </a>
